...
- Active v13 program wrapper tests: 27
- Active v13 program wrapper Kani proofs: 7
...
| `tests/cu_benchmark.rs` | Replaced by v13 LiteSVM CU tests. | `v13_cu_permissionless_crank_refresh_and_recovery_are_bounded`, `v13_cu_crank_cost_is_account_local_after_many_portfolios`. Trade/liquidation CU remains blocked until engine trade is SBF-safe. |
