...
pub const OPEN_LOFS: &[OpenLof] = &[
    ...
    OpenLof::missing(225, Blocker, OracleAccrual),
    OpenLof::quarantined(
        231,
        Blocker,
        ReplayIncarnation,
    ...
    OpenLof::missing(260, Blocker, OracleAccrual),
    OpenLof::missing(264, Blocker, OracleAccrual),
    OpenLof::missing(265, Blocker, OracleAccrual),
    OpenLof::missing(267, Blocker, DomainValue),
    OpenLof::missing(271, Blocker, OracleAccrual),
    OpenLof::missing(272, Blocker, OracleAccrual),
    OpenLof::missing(273, Blocker, RecoveryTerminal),
    OpenLof::missing(274, Hardening, ReplayIncarnation),
    OpenLof::missing(275, Blocker, ReplayIncarnation),
    OpenLof::missing(276, Hardening, ReplayIncarnation),
    OpenLof::missing(277, Blocker, ReplayIncarnation),
    OpenLof::missing(278, Hardening, ReplayIncarnation),
    OpenLof::missing(279, Blocker, ReplayIncarnation),
    OpenLof::missing(280, Blocker, OracleAccrual),
    OpenLof::missing(281, Blocker, DomainValue),
    OpenLof::missing(282, Blocker, OracleAccrual),
    OpenLof::missing(283, Blocker, RecoveryTerminal),
    ...
    OpenLof::missing(290, Blocker, DomainValue),
    ...
    OpenLof::missing(356, Blocker, OracleAccrual),
    ...
    OpenLof::missing(365, Blocker, OracleAccrual),
    ...
    OpenLof::missing(369, Blocker, FeeConsent),
