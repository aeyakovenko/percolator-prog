...
use support::invariant_discovery::{
    ...
    discover_market_incarnation_replays, discover_matcher_revocation_terminal_loss,
    ...
    discover_trade_driven_liquidation_violations, discover_trade_intent_retry_terminal,
