...
use support::fuzz_model::{
    ...
    verify_exact_stock_reconciliation_lifecycle, verify_multi_episode_entitlement_history,
    verify_positive_claim_bound_attribution_lifecycle, verify_resolved_claim_quote_delta,
    verify_resolved_receipt_split_topups, verify_source_credit_rate_lifecycle,
    verify_terminal_dust_payout_protection, verify_underfunded_authority_resolve_claim_orders,
...
#[path = "invariants/stateful/inv_012_capability_and_delegate_scope.rs"]
