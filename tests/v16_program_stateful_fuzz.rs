...
use support::invariant_discovery::{
    ...
    discover_source_lien_reversal_exit_locks, discover_superseded_intents,
    ...
    verify_composite_time_coherence, verify_fractional_movement_convergence,
    verify_hybrid_terminal_time_coherence, verify_matcher_mutation_order_safety,
    verify_resolved_adl_close_orders, verify_stale_cohort_exact_reversal,
    verify_stale_cohort_novation_guards, AccrualOrderingKind, ActiveLegOrder, AssetIntentKind,
