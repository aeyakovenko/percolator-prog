...
use support::invariant_discovery::{
    ...
    discover_composite_time_coherence_violation, discover_cross_domain_insurance_violation,
    discover_fee_consent_violations, discover_fractional_movement_stall, discover_intent_retries,
