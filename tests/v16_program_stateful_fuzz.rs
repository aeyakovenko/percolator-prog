...
use support::invariant_discovery::{
    ...
    discover_oracle_supersession_terminal_losses, discover_pending_mark_admission_violations,
    ...
    discover_trade_intent_retry_terminal, verify_composite_time_coherence,
