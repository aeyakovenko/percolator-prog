...
use support::invariant_discovery::{
    ...
    discover_flat_source_lien_claim_locks, discover_funded_role_seizures,
    discover_hybrid_terminal_snapshot_violation, discover_intent_retries, discover_intent_retry,
    ...
    discover_trade_driven_liquidation_violations, verify_fractional_movement_convergence,
