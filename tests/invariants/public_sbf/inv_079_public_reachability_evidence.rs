...
fn v16_program_open_lof_manifest_snapshot_is_structurally_honest() {
    ...
    assert_eq!(
        quarantined_prs(),
        [
            220, 223, 224, 253, 255, 259, 267, 271, 272, 273, 281, 283, 284, 293, 294, 295, 296,
            307, 310, 314, 317, 325, 326, 329, 331, 334, 335, 336, 337, 338, 339, 340, 343, 344,
            347, 349, 350, 351, 355, 360, 362, 365, 366, 367, 375, 380, 381
        ]
    );
    assert_eq!(
        certified_prs(),
        [
            225, 231, 251, 254, 256, 260, 264, 265, 274, 275, 276, 277, 278, 279, 280, 282, 285,
            290, 292, 299, 301, 303, 304, 305, 309, 311, 312, 313, 315, 316, 318, 320, 321, 322,
            328, 330, 332, 333, 345, 346, 353, 356, 363, 369
        ],
