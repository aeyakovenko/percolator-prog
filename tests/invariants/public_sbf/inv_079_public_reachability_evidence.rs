...
fn v16_program_open_lof_manifest_snapshot_is_structurally_honest() {
    ...
    assert_eq!(
        quarantined_prs(),
        [293, 294, 295, 296, 307, 317, 325, 326, 339]
    );
    assert_eq!(
        certified_prs(),
        [
            ...
            330, 331, 332, 333, 334, 335, 336, 337, 338, 340, 343, 344, 345, 346, 347, 349, 350,
            351, 353, 355, 356, 360, 362, 363, 365, 366, 367, 369, 375, 380, 381
        ],
