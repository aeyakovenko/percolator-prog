...
fn v16_program_open_lof_manifest_snapshot_is_structurally_honest() {
    ...
    assert_eq!(
        ...
        [
            ...
            307, 310, 314, 317, 325, 326, 329, 331, 339, 360, 365, 366, 367, 375, 380, 381
        ]
    );
    assert_eq!(
        certified_prs(),
        [
            ...
            328, 330, 332, 333, 334, 335, 336, 337, 338, 340, 343, 344, 345, 346, 347, 349, 350,
            351, 353, 355, 356, 362, 363, 369
        ],
