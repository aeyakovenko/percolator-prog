...
fn v16_program_open_lof_manifest_snapshot_is_structurally_honest() {
    ...
    assert_eq!(
        quarantined_prs(),
        [
            220, 255, 259, 267, 271, 272, 273, 281, 283, 284, 293, 294, 295, 296, 307, 317, 325,
            326, 331, 339, 360, 366, 367, 375, 380
        ]
    );
    assert_eq!(
        certified_prs(),
        [
            223, 224, 225, 231, 251, 253, 254, 256, 260, 264, 265, 274, 275, 276, 277, 278, 279,
            280, 282, 285, 290, 292, 299, 301, 303, 304, 305, 309, 310, 311, 312, 313, 314, 315,
            316, 318, 320, 321, 322, 328, 329, 330, 332, 333, 334, 335, 336, 337, 338, 340, 343,
            344, 345, 346, 347, 349, 350, 351, 353, 355, 356, 362, 363, 365, 369, 381
        ],
