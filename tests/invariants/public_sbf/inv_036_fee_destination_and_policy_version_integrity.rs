...
//!
//! Evidence in this file (I plus invariant-specific F/M assertions): `v16_program_pr224_unsigned_lp_caller_fee_is_withdrawable`, `v16_program_pr223_unsigned_lp_backing_fee_is_withdrawable`, `v16_program_pr314_activation_fee_consent_extracts_unsigned_increase`, `v16_program_pr310_bilateral_base_fee_consent_extracts_victim_fee`. These tests exercise the deployed public
