...
#[kani::proof]
fn kani_v16_asset_topups_reject_generationless_legacy_payloads() {
...
#[kani::proof]
fn kani_v16_generationless_oracle_payloads_reject() {
    let mut hybrid = [0u8; 164];
    hybrid[0] = 34;
    assert!(Instruction::decode(&hybrid).is_err());
