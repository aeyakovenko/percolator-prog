...
fn v16_program_cold_oracle_replacement_preserves_funded_coholder_and_atomic_prefix() {
    ...
    for asset in [0u16, 1] {
        ...
        let observation = Instruction {
            ...
            data: ProgInstruction::PushAuthMark {
                ...
                observation_sequence: next_control_sequence(expected_sequences.oracle_observation),
                now_slot: u64::MAX,
                mark_e6: 100,
            }
            .encode(),
    ...
    eprintln!("INV-005 cold oracle funded containment: 2 live worlds, 2 exact SPL/oracle/observation rollbacks, 2 cold-signed oracle replacements, 4 incumbent backing payouts, peak {peak_cu} CU");
}
