...
fn inv088_source_defines_test(source: &str, function: &str) -> bool {
...
fn v16_program_every_wrapper_engine_transition_callsite_has_summary_disposition_and_witness() {
    const ROWS: &[Inv088EngineCallsite] = &[
        ...
        Inv088EngineCallsite { owner: "credit_maintenance_fee_to_active_market_budgets_view", method: "credit_domain_insurance_budget_not_atomic", count: 2, summary_family: "insurance-budget", witness: "v16_program_maintenance_fee_split_is_cadence_independent" },
        ...
        Inv088EngineCallsite { owner: "resolve_market_view", method: "resolve_market_not_atomic", count: 1, summary_family: "payout-snapshot", witness: "v16_program_authority_and_permissionless_resolution_match_at_maturity" },
        ...
        Inv088EngineCallsite { owner: "handle_push_managed_mark", method: "set_asset_raw_oracle_target_not_atomic", count: 1, summary_family: "asset-oracle", witness: "v16_program_ewma_mark_respects_per_slot_circuit_breaker" },
