...
fn v16_program_alternate_entrypoints_cannot_select_internal_safety_lanes() {
    ...
    // INV-083 owns the 229 field-or-no-data boundary matrix. Source-lock the composition edge so
    ...
    assert!(BOUNDARY_TESTS.contains("const EXPECTED_FIELD_COUNT: usize = 229;"));
