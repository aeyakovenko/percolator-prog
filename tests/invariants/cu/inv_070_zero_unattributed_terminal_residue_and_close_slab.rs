...
#[path = "inv_070_terminal_custody_program_recreation.rs"]
mod terminal_custody_program_recreation;
...
fn v16_attack_permissionless_asset_insurance_authority_cannot_withhold_terminal_close() {
    ...
    attack.env.svm.expire_blockhash();
    let close_authority_epoch = attack.env.control_sequences(0).authority_epoch;
