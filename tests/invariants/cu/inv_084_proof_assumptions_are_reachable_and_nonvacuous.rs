...
//! compares it exactly with the manifest. It also derives all 141 direct and 36
...
fn v16_program_every_mounted_kani_harness_has_a_nonvacuity_disposition() {
    ...
    const EXPECTED_DIRECT_HARNESSES: usize = 141;
    const EXPECTED_GENERATED_HARNESSES: usize = 36;
    const EXPECTED_TOTAL_HARNESSES: usize = 177;
