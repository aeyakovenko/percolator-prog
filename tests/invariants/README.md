...
| `cargo test --test v16_program_fuzz_regressions` | 95/95 | full engine-`fdf11670`/SBF-`3b14d7b8` exact-source rerun in 27.07 seconds; every current public trace consumer validates normalized reachability evidence, and the sealed benchmark census, audit ledger, special-method registry, and invariant registries remain green |
| `cargo test --test v16_cu` | 845/845 | full engine-`fdf11670`/SBF-`3b14d7b8` exact-source rerun passed in 199.77 seconds on the 2026-08-21 checkpoint; zero failures, including maximum-shape two-sided source-lien release, the source-complete INV-085 arithmetic census, bigint boundary/provider references, exact host-to-SBF comparisons, and INV-080 error-disposition/dispatcher/entrypoint/later-consumer composition |
