...
| `stateful/` | 108 | Proptest-generated public routes, including forty finding-agnostic discovery properties |
...
**Direct regression** rows, 47 **Missing** rows, and 96 **Independent discovery** rows. The independent
