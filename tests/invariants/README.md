...
| `stateful/` | 104 | Proptest-generated public routes, including thirty-six finding-agnostic discovery properties |
...
**Direct regression** rows, 51 **Missing** rows, and 92 **Independent discovery** rows. The independent
