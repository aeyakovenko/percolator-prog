...
| `cargo test --test v16_program_stateful_fuzz` | 207/207 | full exact engine-`d604ca0`/SBF-`e52a9cfb` rerun completed in 262.74 seconds; every generated public action and successful crank composes the shared invariant oracles for both markets, including the complete pending-obligation and close-ledger encumbrance census, direct per-domain `usable_positive_credit_num <= available_backing_num`, exact/bound claim transitions, credit-rate edge causality, and the independent resolved-payout quotient/remainder oracle. The suite includes the finding-blind 11-operation whole-market no-reuse property, 56-world one-domain, 48-world two-domain, and 48-world mixed-expiry INV-052 source-lien matrices, the eight-world nonintegral backing-fee account/domain partition product, exact per-portfolio source attribution and close exclusion, the asymmetric-fee INV-041 order regression, INV-076 rollback frames, the finding-blind 21-family retained asset-generation matrix, source-domain single-use, retained source-fee consent, backing-provider landing-order campaigns, all-route EWMA aggregate/partition/dust fee conservation, and the byte-identical INV-039 partial-liquidation/accrual ordering pair. All authority, policy, lifecycle, liveness, accounting, and model campaigns pass. |
...
| `cargo test --test v16_cu` | 915/915 | full exact engine-`d604ca0`/SBF-`e52a9cfb` rerun completed in 204.26 seconds; zero behavioral failures across market tombstone/rent/fresh-address behavior, matcher identity/incarnation and stateless-PDA composition, reserve, fee-policy/destination ownership, claim/backing/insurance single-use, exact lien lifecycle, source-realizability, exact-claim, credit-rate transition composition, exact B-booking/account-settlement/carry-normalization partitions, aggregate-versus-one-atom social-loss composition, the source-complete truncating-arithmetic ownership census, odd activation/redirect partitions, oracle, Recovery, terminal, source-lien normalization, selector composition, equivalent-route source composition, pending-obligation close rollback/release, and maximum-shape routes. Every observed required exit remains below the 1.4M CU ceiling; the run observed 1,116,641 CU for max-source liquidation and 1,314,291 CU for max-shape resolved close. The non-exit 28th-lien admission reached 1,398,554 CU and remains an explicit thin-headroom risk. |
