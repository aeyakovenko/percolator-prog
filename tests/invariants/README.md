...
| `cargo test --test v16_program_fuzz_regressions` | 95/95 | full engine-`b10b3454`/SBF-`342f7bb5` exact-source rerun in 27.12 seconds; every current public trace consumer validates normalized reachability evidence, and the sealed benchmark census, audit ledger, special-method registry, and invariant registries remain green |
