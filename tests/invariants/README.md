...
| Focused INV-085 deployed arithmetic differential | 10/10 host/CU plus 12/12 Kani and 126/126 public composite worlds | a source-derived roster owns all 30 multiply/divide-bearing production functions and keeps eight canonical fee/notional adapters in `policy_v16`; twelve wrapper policy/oracle relations match independent widened formulas over complete bounded products, fixed boundaries, and 16,384 deterministic full-width words; 512 dynamic-fee and 1,024 fee-rate-search words match exhaustive scans. Every legal three-provider composition topology lands its independently calculated rational E6 price through the deployed SBF route. Full relational scaling, explicit host/SBF boundaries, and bigint equivalence remain frontier work. |
...
| `cargo test --test v16_program_fuzz_regressions` | 93/93 | full engine-`592d538c`/SBF-`a9735d04` exact-source rerun in 26.99 seconds; the sealed benchmark census, audit ledger, special-method registry, and invariant registries remain green after arithmetic canonicalization |
| `cargo test --test v16_cu` | 836/836 | full engine-`592d538c`/SBF-`a9735d04` exact-source rerun passed in 198.63 seconds on the 2026-08-21 checkpoint; zero failures, including the source-complete INV-085 arithmetic census, canonical-adapter differentials, exact public fee routes, and updated INV-084/087 rosters |
