...
| `cargo test --test v16_program_stateful_fuzz` | 228/228 | full exact engine-`6f3c5c12`/SBF-`d70956aa` rerun completed in 239.70 seconds. The 16-world partial-receipt release/claim order matrix and four-route terminal-expiry branch pass the independent stock, encumbrance, OI, custody, rollback, exact-once, and terminal-liveness oracles alongside every prior authority, policy, liquidation, payout, and bounded-reference campaign. |
