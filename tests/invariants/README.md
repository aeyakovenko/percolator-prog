...
`49eea32e35eb46c6cf072a5b73faae15dfc0ff9bf0fadb8ae9d4b33ccf8a6176`. Resolved-mode
...
| `cargo test --test v16_program_stateful_fuzz` | 182/182 | full engine-`ba7a84b7`/SBF-`49eea32e` rerun in 167.26 seconds, including the new 24-world source-lien partition/expiry/exit matrix, generated aggregate/split/reversed terminal-insurance withdrawal, resolved-claim and liquidation partition matrices, Recovery K/F refresh, close drift, exact rollback, and every shared rank/reference-model check |
| Registry/manifest checks in the INV-079 module | 9/9 | rerun on the 2026-08-21 PR135 exact-pin test head |
| `cargo test --test v16_program_fuzz_regressions` | 93/93 | full engine-`ba7a84b7`/SBF-`49eea32e` rerun in 26.80 seconds; the sealed benchmark census and invariant registries remain green |
| `cargo test --test v16_cu` | 794/794 | full engine-`ba7a84b7`/SBF-`49eea32e` exact-source rerun in 186.96 seconds, including all maximum-source and maximum-shape exits, liquidation/resolved close, exhaustive account-role matrices, the dense zero-delta terminal-shape benchmark, and every cross-invariant progress/rollback audit; no CU regression followed the ceil change |
...
`49eea32e35eb46c6cf072a5b73faae15dfc0ff9bf0fadb8ae9d4b33ccf8a6176`.
