...
| `cargo test --test v16_cu` | 794/794 | full engine-`3b76b794`/SBF-`97eb59e9` rerun in 192.45 seconds, including Hybrid/Pyth, AuthMark, and EWMA fixed-point rejection, maximum-source exits, maximum-shape Recovery obligation and K/F cohort cleanup, liquidation/resolved close, exhaustive account-role matrices, the dense zero-delta terminal-shape benchmark, and B-before-claim reset-carry retirement |
