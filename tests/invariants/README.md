...
| `stateful/` | 105 | Proptest-generated public routes, including thirty-seven finding-agnostic discovery properties |
...
**Direct regression** rows, 50 **Missing** rows, and 93 **Independent discovery** rows. The independent
