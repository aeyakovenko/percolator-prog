...
roster passes 161/161. Arbitrary relational wide scale division remains behind the arithmetic wall
...
sources: 125 direct harnesses plus 36 macro-generated trade-decoder harnesses, exactly matching the
161 reported by `cargo kani list`. Every direct harness is classified into 67 symbolic-total, 20
...
| `cargo test --test v16_cu` | 831/831 | full engine-`592d538c`/SBF-`53c07731` exact-source rerun in 981.69 seconds, including INV-084's complete 161-harness disposition audit, source-complete 13-assumption/19-module audit, and public admitted/excluded-domain composition; INV-083's 206-field/53-type/20-profile boundary inventory and 25 public initialization rejection partitions; the complete 53-call-site INV-088 transition roster; all backing, insurance, source-claim, earnings, and resolved-claimant order matrices; all maximum-source and maximum-shape exits; stale-Hybrid 14-leg delegated-CPI terminal compositions; byte-complete persisted-slot activation/reuse equivalence; exact maximum cross-zero boundaries; all-route lifecycle admission; exhaustive account-role matrices; parser, layout, confidence, oracle, liquidation, shutdown/restart, backing/insurance, and terminal-shape campaigns; and every cross-invariant progress/rollback audit |
| `cargo kani --bin v16-kani --features kani --default-unwind 18 --output-format terse` | 161/161 | full wrapper-only exact-pin rerun on the patched 2026-08-21 production head with engine `592d538c`; zero harness failures, including all 20 branch-limited proof classes with constructive covers, all 13 source-inventoried assumptions, 11 focused INV-084 nonvacuity harnesses, 16 assumption-free provider-parser decomposition harnesses, and all prior decoder, arithmetic, and rollback proofs |
...
| AUDIT-084 | CLOSED | A host source audit derives all 125 direct and 36 macro-generated harnesses from all 19 mounted modules, exactly matching `cargo kani list`, and locks 67 symbolic-total, 20 branch-witnessed, 10 explicitly constrained, 28 concrete-exact, and 36 generated-symbolic dispositions. Every branch-limited claim has a satisfiable cover; every concrete-fixture module has assertion-bearing proofs and named public evidence; every generated proof is tied to the symbolic macro template and assertion helper. All 13 explicit assumptions retain exact file/line/predicate ownership, constructive Kani witnesses, classification, and public-route evidence. Full-width partitions pin off-by-one, widening, dropped-mark-clause, cap, epoch, identity, sequence, and zero-size mutations. The stale eight-site/ten-module claim is removed. A new mounted module, harness, macro generator, assumption, branch-limited claim, or concrete-fixture module reopens this row. |
