...
884/884 LiteSVM/CU tests, 100/100 public fuzz regressions, and 206/206 stateful/model tests. Static
...
| `cargo test --test v16_cu` | 884/884 | full engine-`b10b3454`/SBF-`fb16e50e` exact-source rerun passed in 207.57 seconds on the 2026-08-26 checkpoint; zero failures, including all 50 account-role matrices, reserve, Hybrid-oracle, public Recovery, terminal slab, lifecycle, maximum-shape, and prior invariant routes |
...
The current ledger is 18 **CLOSED**, 38 **OPEN-T**, 14 **OPEN-D**, 5 **PARTIAL**, 12 **FRONTIER**,
...
On engine pin `b10b3454dd03dcf4c04a020dc1a90381ff179200`, the full 884-test `v16_cu` inventory is
