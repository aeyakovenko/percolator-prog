...
| `stateful/` | 103 | Proptest-generated public routes, including thirty-five finding-agnostic discovery properties |
...
**Direct regression** rows, 52 **Missing** rows, and 91 **Independent discovery** rows. The independent
