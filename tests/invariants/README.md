...
4. Complete INV-076's fallible-phase decomposition. Public tests now own rollback after mutating
...
The current ledger is 63 **CLOSED**, 2 **OPEN-T**, 10 **OPEN-D**, 0 **PARTIAL**, 12 **FRONTIER**,
