...
| `stateful/` | 109 | Proptest-generated public routes, including forty-one finding-agnostic discovery properties |
...
**Direct regression** rows, 46 **Missing** rows, and 97 **Independent discovery** rows. The independent
