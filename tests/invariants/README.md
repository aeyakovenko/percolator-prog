...
| `cargo check --tests` | pass | exact engine-`b10b3454` build completed in 18.76 seconds on the 2026-08-21 PR135 production head |
| `cargo test --lib` | 7/7 | exact engine-`b10b3454` rerun on the 2026-08-21 PR135 production head |
| `cargo test --test v16_program_stateful_fuzz` | 196/196 | exact engine-`b10b3454`/SBF-`342f7bb5` rerun in 176.96 seconds, including the 32-world live source-lien route-pair ownership matrix, four independent flat-source-lien route worlds with complete terminal observations, source-complete validation of every current public trace consumer, and every prior rank/reference-model, lifecycle, source-lien, terminal, and route-composition check |
| Registry/manifest checks in the INV-079 module | 11/11 | rerun on the 2026-08-21 PR135 exact-pin test head; includes complete-route terminal classification and the recursive 26-consumer source guard |
| `cargo test --test v16_program_fuzz_regressions` | 95/95 | full engine-`b10b3454`/SBF-`342f7bb5` exact-source rerun in 27.21 seconds; every current public trace consumer validates normalized reachability evidence, and the sealed benchmark census, audit ledger, special-method registry, and invariant registries remain green |
