...
| `stateful/` | 77 | Proptest-generated public routes, including nine finding-agnostic operation matrices |
...
public-route LoF or DoS class. It maps every row to a primary invariant. PR135 currently has 27
**Direct regression** rows, 62 **Missing** rows, and 56 **Independent discovery** rows. The independent
