...
| `stateful/` | 110 | Proptest-generated public routes, including forty-two finding-agnostic discovery properties |
...
**Direct regression** rows, 45 **Missing** rows, and 98 **Independent discovery** rows. The independent
