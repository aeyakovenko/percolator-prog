...
| `cargo test --test v16_program_stateful_fuzz` | 201/201 | full exact engine-`b10b3454`/SBF-`342f7bb5` rerun completed in 258.98 seconds; 224 bidirectional supersession worlds and two value-moving underfunded authority/claim worlds join every prior stateful check |
...
| `cargo test --test v16_program_fuzz_regressions` | 97/97 | full engine-`b10b3454`/SBF-`342f7bb5` exact-source rerun in 27.17 seconds; every retained family passes the same-transaction duplicate matrix, all 16 ordered retained-trade route pairs are exact-once, all 27 public trace consumers validate normalized reachability evidence, and the sealed benchmark census, audit ledger, special-method registry, and invariant registries remain green |
