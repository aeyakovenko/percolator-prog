...
| `cargo test --test v16_program_fuzz_regressions` | 101/101 | full engine-`b10b3454`/SBF-`fb16e50e` exact-source rerun in 27.52 seconds on 2026-08-26; includes the retained backing-earnings generation replay and all prior public regressions, trace consumers, and registries |
| `cargo test --test v16_cu` | 886/886 | full engine-`b10b3454`/SBF-`fb16e50e` exact-source rerun passed in 200.91 seconds on the 2026-08-26 checkpoint; zero failures, including all 50 account-role matrices, reserve, Hybrid-oracle, public Recovery, terminal slab, lifecycle, maximum-shape, and prior invariant routes |
...
On engine pin `b10b3454dd03dcf4c04a020dc1a90381ff179200`, the full 886-test `v16_cu` inventory is
