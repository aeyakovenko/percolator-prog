...
prevents this progress from being overstated: 37 instruction variants have exhaustive current-shape
matrices, four have an explicitly named dynamic-tail/action gap, and nine remain open. Fresh
...
| `cargo test --test v16_cu` | 875/875 | full engine-`b10b3454`/SBF-`fb16e50e` exact-source rerun passed in 195.02 seconds on the 2026-08-26 checkpoint; zero failures, including public `FinalizeResetSide` and `RestartAssetOracle` role matrices and every prior maximum-shape and invariant route |
