...
| `cu/` | 72 | Positive public-route, metamorphic, rollback, liveness, and max-shape CU tests |
...
**Direct regression** rows, 40 **Missing** rows, and 103 **Independent discovery** rows. The independent
