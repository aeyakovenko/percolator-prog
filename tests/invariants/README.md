...
| Focused INV-053 certificate-equivalence and active-leg observation matrices | 20/20 incremental/full-refresh route/shape worlds; 14/14 single omissions reject exactly; 1/1 complete set succeeds | every public trade transport settles a genuinely stale unrelated leg across attach, resize, reduce, cross-zero, and clear, then matches a public full recomputation lane-for-lane; maximum-shape 14-leg AuthMark refresh measured at 794,956 CU |
