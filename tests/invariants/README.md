...
| `cargo test --test v16_cu` | 844/844 | full engine-`fdf11670`/SBF-`3b14d7b8` exact-source rerun passed in 203.64 seconds on the 2026-08-21 checkpoint; zero failures, including the source-complete INV-085 arithmetic census, bigint boundary/provider references, exact host-to-SBF comparisons, and INV-080 error-disposition/dispatcher/entrypoint/later-consumer composition |
