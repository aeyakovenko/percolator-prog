...
change reopens the row. INV-075 separately owns the specification choice between first-landed
exclusion and priority preemption.
...
The current ledger is 65 **CLOSED**, 0 **OPEN-T**, 10 **OPEN-D**, 0 **PARTIAL**, 12 **FRONTIER**,
