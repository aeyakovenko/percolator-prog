...
1. Convert the 12 `Quarantined` adapters to `Certified` only after the current pin satisfies their
   positive economic and liveness postconditions. The other 87 entries already have explicit
   executable disposition: 79 fixed-pin certifications and 8 public nonqualifying proofs. Do not
...
The executable 99-finding manifest currently contains 79 `Certified`, 12 `Quarantined`, 8
...
79 are `Certified`, 12 remain `Quarantined`, 8 are `Nonqualifying`, and none are `Missing`. Its
