...
No parallel parser or narrowed field model is used.

The exact rebuilt SBF is 1,231,832 bytes with SHA-256
`327c796cfa9d08e517dc3746718de6053e6fddd37fed0dba6e2e36b02279c96d`. Across the combined
route removal, epoch-binding, and decoder simplification work, production remains 228 source lines
...
| `cargo test --test v16_program_stateful_fuzz` | 202/202 | full exact engine-`9b737fd`/SBF-`327c796c` rerun completed in 262.91 seconds; the 34-case/272-world authority-incarnation matrix, every retained-policy landing order, and every prior stateful/model check pass |
...
| `cargo test --test v16_program_fuzz_regressions` | 102/102 | full exact engine-`9b737fd`/SBF-`327c796c` rerun completed in 27.61 seconds; includes all public regressions, trace consumers, executable registries, and the source-complete INV-079 evidence roster |
| `cargo test --test v16_cu` | 891/891 | full exact engine-`9b737fd`/SBF-`327c796c` rerun completed in 202.22 seconds; zero behavioral failures, including the source-complete authority-epoch route/decoder matrices, canonical permissionless lifecycle epoch, proof/deployed-dispatch source lock, and all prior reserve, oracle, Recovery, terminal, lifecycle, and maximum-shape routes |
