...
191 engine host/runtime tests, 111 public regressions, 223 public stateful/model tests, and all 916
...
Transfer, partial-receipt close, retirement composition, and arbitrary liquidation splitting remain
in the broader INV-051 frontier; partial-receipt close is the next tractable whole-route product.
