...
| `stateful/` | 78 | Proptest-generated public routes, including ten finding-agnostic operation matrices |
...
public-route LoF or DoS class. It maps every row to a primary invariant. PR135 currently has 24
**Direct regression** rows, 62 **Missing** rows, and 59 **Independent discovery** rows. The independent
