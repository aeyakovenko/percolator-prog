...
| `cargo test --test v16_program_stateful_fuzz` | 178/178 | full engine-`3b76b794`/SBF-`97eb59e9` rerun in 163.87 seconds, including generated aggregate/split/reversed terminal-insurance withdrawal, Recovery K/F refresh, success-must-mutate/fixed-point rollback checks, both active-close/shutdown landing orders, and every shared rank/reference-model check |
