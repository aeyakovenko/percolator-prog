...
| `cargo test --test v16_program_stateful_fuzz` | 230/230 | full exact engine-`6f3c5c12`/SBF-`d70956aa` rerun completed in 253.81 seconds. The 48-world aggregate/two-way/three-way receipt route matrix, 24-world unequal three-receipt claimant/release product, 16-world partial-receipt release/claim matrix, four-world independent-Recovery/receipt product, and four-route terminal-expiry branch pass alongside every prior authority, policy, liquidation, payout, and bounded-reference campaign. |
