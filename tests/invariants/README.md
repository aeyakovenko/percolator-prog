...
| `cargo test --test v16_program_stateful_fuzz` | 206/206 | full exact engine-`b10b3454`/SBF-`02c40bcb` rerun completed in 257.91 seconds; the expanded three-kind same-portfolio episode generator and every prior stateful check pass |
...
The current ledger is 10 **CLOSED**, 44 **OPEN-T**, 16 **OPEN-D**, 6 **PARTIAL**, 12 **FRONTIER**,
