...
persisted aggregate, public writer, or larger supported shape reopens it. The next adjacent target
is INV-083's field-complete arithmetic and lifecycle boundary inventory.
...
| `cargo test --test v16_cu` | 827/827 | full engine-`592d538c`/SBF-`53c07731` exact-source rerun in 191.69 seconds, including the complete 53-call-site INV-088 transition roster; all 24 four-domain backing and insurance orders; both insurance withdrawal, source-claim realization/conversion, and backing-earnings accrual/withdrawal orders; all 24 two-asset resolved claimant orders; all maximum-source and maximum-shape exits; stale-Hybrid 14-leg delegated-CPI compositions through Resolved and Recovery with exact terminal value; byte-complete persisted-slot activation/reuse equivalence; exact maximum cross-zero boundaries; all-route lifecycle admission; exhaustive account-role matrices; parser, layout, confidence, oracle, liquidation, shutdown/restart, backing/insurance, and terminal-shape campaigns; and every cross-invariant progress/rollback audit |
...
The current ledger is 6 **CLOSED**, 51 **OPEN-T**, 12 **OPEN-D**, 6 **PARTIAL**, 13 **FRONTIER**,
