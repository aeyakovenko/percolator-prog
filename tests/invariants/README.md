...
| `stateful/` | 102 | Proptest-generated public routes, including thirty-four finding-agnostic discovery properties |
...
**Direct regression** rows, 53 **Missing** rows, and 90 **Independent discovery** rows. The independent
