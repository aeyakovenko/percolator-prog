...
| `cargo test --test v16_program_stateful_fuzz` | 206/206 | full exact engine-`d604ca0`/SBF-`e52a9cfb` rerun completed in 265.89 seconds; every generated public action and successful crank composes the shared invariant oracles for both markets, including the complete pending-obligation and close-ledger encumbrance census, direct per-domain `usable_positive_credit_num <= available_backing_num`, exact/bound claim transitions, credit-rate edge causality, and the independent resolved-payout quotient/remainder oracle. The suite includes the finding-blind 11-operation whole-market no-reuse property, 56-world one-domain, 48-world two-domain, and 48-world mixed-expiry INV-052 source-lien matrices, the eight-world nonintegral backing-fee account/domain partition product, exact per-portfolio source attribution and close exclusion, the asymmetric-fee INV-041 order regression, INV-076 rollback frames, the finding-blind 21-family retained asset-generation matrix, source-domain single-use, retained source-fee consent, backing-provider landing-order campaigns, and all-route EWMA aggregate/partition/dust fee conservation. All authority, policy, lifecycle, liveness, accounting, and model campaigns pass. |
