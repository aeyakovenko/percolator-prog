...
The current ledger is 80 **CLOSED**, 0 **OPEN-T**, 6 **OPEN-D**, 0 **PARTIAL**, 1 **FRONTIER**,
...
6. Kani proofs cover local wrapper helpers and explicit engine-contract composition boundaries.
   ...
   still no single theorem asserting every one of the 89 charter invariants after every successful
   public wrapper instruction. Harness nonvacuity and source rosters do not create that theorem;
   this is the remaining INV-081 frontier.
