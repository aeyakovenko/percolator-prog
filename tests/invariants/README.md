...
| `cu/` | 100 | Positive public-route, metamorphic, rollback, liveness, and max-shape CU tests |
...
**Direct regression** rows, 4 **Missing** rows, 123 **Independent discovery** rows, and sixteen
