...
| `cargo test --test v16_program_fuzz_regressions` | 106/106 | full exact engine-`6c8d94bc`/SBF-`a76dd082` rerun completed in 27.62 seconds after the B-prerequisite/liquidation composition increment; includes all public regressions, trace consumers, executable registries, and the source-complete INV-079 evidence roster |
| `cargo test --test v16_cu` | 898/898 | full exact engine-`6c8d94bc`/SBF-`a76dd082` rerun completed in 203.73 seconds after the public B-prerequisite/liquidation composition increment; zero behavioral failures across reserve, fee-consent, oracle, Recovery, terminal, lifecycle, source-lien normalization, selector composition, and maximum-shape routes. Every observed required exit remains below the 1.4M CU ceiling. |
...
normalization and dispatch; wrapper production code is unchanged, and the complete 898-test CU
suite remains green.
...
1. Generalize the concrete actionability-fidelity oracle that exposed the mixed-expiry DoS. For
   ...
   than an injected state. Continue with reachable stale/lower-priority overlaps.
...
On engine pin `6c8d94bcacb8110c8e86ce1b1fc46594bb672a7c`, the full 898-test `v16_cu` inventory is
