...
asset-local-checkpoint regression passes, and the 239th stateful/model test exhausts the
oracle-failure frontier in 32.7 seconds with the other 238 tests filtered. The last unchanged broad
...
frontier a 237th, the receipt-conflict frontier a 238th, and the oracle-failure frontier a 239th.
