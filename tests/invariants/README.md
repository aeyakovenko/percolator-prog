...
| `cargo test --test v16_program_fuzz_regressions` | 93/93 | full engine-`592d538c`/SBF-`23db9e77` exact-source rerun in 26.77 seconds; the sealed benchmark census, audit ledger, special-method registry, and invariant registries remain green after bigint arithmetic coverage |
| `cargo test --test v16_cu` | 841/841 | full engine-`592d538c`/SBF-`23db9e77` exact-source rerun passed in 197.15 seconds on the 2026-08-21 checkpoint; zero failures, including the source-complete INV-085 arithmetic census, bigint boundary/provider references, exact activation-tier/fee-share/batch/Hybrid host-to-SBF comparisons, and updated INV-084/087 rosters |
