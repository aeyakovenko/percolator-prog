...
account layout. A new wrapper-owned field or public mutation route reopens the row. The next
adjacent target is INV-088's complete aggregate-writer-to-public-route inventory and adversarial
touch-order matrix.
...
The current ledger is 5 **CLOSED**, 52 **OPEN-T**, 12 **OPEN-D**, 6 **PARTIAL**, 13 **FRONTIER**,
