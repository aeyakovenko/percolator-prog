...
| `cargo test --test v16_cu` | 895/895 | full exact engine-`6c8d94bc`/SBF-`a76dd082` rerun completed in 199.93 seconds on `7497a8cc`; zero behavioral failures across reserve, fee-consent, oracle, Recovery, terminal, lifecycle, source-lien normalization, and maximum-shape routes. Every observed required exit remains below the 1.4M CU ceiling. |
...
normalization and dispatch; wrapper production code is unchanged, and the complete 895-test CU
suite remains green.
...
On engine pin `6c8d94bcacb8110c8e86ce1b1fc46594bb672a7c`, the full 895-test `v16_cu` inventory is
