...
| `stateful/` | 106 | Proptest-generated public routes, including thirty-eight finding-agnostic discovery properties |
...
**Direct regression** rows, 49 **Missing** rows, and 94 **Independent discovery** rows. The independent
