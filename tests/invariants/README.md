...
| `stateful/` | 107 | Proptest-generated public routes, including thirty-nine finding-agnostic discovery properties |
...
**Direct regression** rows, 48 **Missing** rows, and 95 **Independent discovery** rows. The independent
