...
`f09719225eec98b485f99e834520dff259f6ed72669f25c68ae462c4570fe05c`. Resolved-mode
...
`f09719225eec98b485f99e834520dff259f6ed72669f25c68ae462c4570fe05c`.
...
2. Decompose INV-020 parser semantics into tractable per-provider field, scale, freshness, and
   confidence theorems plus a proved dispatch/composition layer over the actual pure production
   parser. The runtime side now includes nine single-provider and eighteen multi-provider lifecycle
   worlds with denominator, expiry, malformed-tail rollback, and exact value attribution. Extend
   that finite matrix to invert/unit-scale lifecycle pairs only where they add behavior beyond the
   existing 126-case transform matrix. The all-symbolic relational wide-product theorem remains
   solver-bound; finite generation and totality are not proof of every provider byte word.
