...
theorem. The exact current artifact passes 907/907 CU tests; the full Kani result is recorded below.
...
| `cargo test --test v16_cu` | 907/907 | full exact engine-`d604ca0`/SBF-`e52a9cfb` rerun completed in 193.14 seconds; zero behavioral failures across market tombstone/rent/fresh-address behavior, matcher identity/incarnation and stateless-PDA composition, reserve, fee-policy/destination ownership, claim/backing/insurance single-use, exact lien lifecycle, oracle, Recovery, terminal, source-lien normalization, selector composition, and maximum-shape routes. Every observed required exit remains below the 1.4M CU ceiling; the run observed 1,116,641 CU for max-source liquidation and 1,314,291 CU for max-shape resolved close. |
...
engine branch. The complete 907-test CU suite remains green.
...
thirteen focused INV-036 CU tests and full 907-test deployed-SBF suite pass. No production code or
...
zero partial/open rows; every cited role test is present, and the exact 907-test CU run executes the
...
The current ledger is 33 **CLOSED**, 31 **OPEN-T**, 11 **OPEN-D**, 0 **PARTIAL**, 12 **FRONTIER**,
...
On engine pin `d604ca09b7e584d3875ce4516bab1186346bf4a6`, the full 907-test `v16_cu` inventory is
