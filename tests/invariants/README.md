...
196 engine host/runtime tests, 7 wrapper unit tests, 111 public regressions, 228 public
stateful/model tests, all 919 LiteSVM/CU tests, and all 193 wrapper Kani harnesses. The six focused
...
| Focused INV-052/066 public resolved-claim split/order matrix | 48/48 aggregate/two-way/three-way route worlds plus 24/24 three-claimant order/release worlds | one exact claim face is held by one portfolio, split equally across two, or split unequally as `350/650/1000` across three concurrent receipts. Every open/close route pair is equivalent; splitting never increases payout and loses at most N-1 conservative floor atoms. The three-way matrix additionally exhausts all `3!` claimant orders and all four insertion points of an exact-expiry backing release, observes a nonzero full-width remainder in every world, retires every claim, and preserves exact claimant-local payouts and engine/SPL custody. |
...
| `cargo test --test v16_program_stateful_fuzz` | 231/231 | full exact engine-`6f3c5c12`/SBF-`d70956aa` rerun completed in 245.53 seconds. The 48-world aggregate/two-way/three-way receipt route matrix, 24-world unequal three-receipt claimant/release product, its second 24-world prior-insurance composition through gated drain and slab closure, 16-world partial-receipt release/claim matrix, four-world independent-Recovery/receipt product, and four-route terminal-expiry branch pass alongside every prior authority, policy, liquidation, payout, and bounded-reference campaign. |
...
| `cargo test --test v16_program_fuzz_regressions` | 111/111 | full exact engine-`6f3c5c12`/SBF-`d70956aa` rerun completed in 26.25 seconds; all public regressions, executable registries, 59 trace consumers, and the 32-oracle INV-079 evidence roster pass |
