...
theorem. The exact current artifact passes 908/908 CU tests; the full Kani result is recorded below.
...
| `cargo test --test v16_cu` | 908/908 | full exact engine-`d604ca0`/SBF-`e52a9cfb` rerun completed in 198.83 seconds; zero behavioral failures across market tombstone/rent/fresh-address behavior, matcher identity/incarnation and stateless-PDA composition, reserve, fee-policy/destination ownership, claim/backing/insurance single-use, exact lien lifecycle, oracle, Recovery, terminal, source-lien normalization, selector composition, equivalent-route source composition, and maximum-shape routes. Every observed required exit remains below the 1.4M CU ceiling; the run observed 1,116,641 CU for max-source liquidation and 1,314,291 CU for max-shape resolved close. |
...
The current ledger is 34 **CLOSED**, 30 **OPEN-T**, 11 **OPEN-D**, 0 **PARTIAL**, 12 **FRONTIER**,
