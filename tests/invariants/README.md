...
1. Complete the live open-issue coverage roster. The retained-operation matrix covers eleven
   ...
   evidence.
2. Add public-SBF owners for the remaining crank-cadence findings (issues 407 and 409). Issue 406's
   matcher-inventory reconciliation and issue 408's maintenance-debt seniority are closed by
   INV-004/INV-012 and INV-027/INV-036/INV-040 public-route evidence. Each remaining owner must
   distinguish a live counterexample from a
...
| `cu/` | 732 | Full `v16_cu` public-route, metamorphic, rollback, liveness, arithmetic-differential, and max-shape CU inventory, including issue-404 transient-rent boundaries, issue-405 selected-Switchboard-result provenance, issue-406 matcher-inventory synchronization, and issue-408 maintenance seniority across standing-matcher and liquidation routes, with exact attribution, progress, and max-shape controls, with no standalone top-level tests |
