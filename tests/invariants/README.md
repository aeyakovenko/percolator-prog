...
| `cargo test --test v16_program_stateful_fuzz` | 179/179 | full engine-`3b76b794`/SBF-`97eb59e9` rerun in 166.27 seconds, including generated aggregate/split/reversed terminal-insurance withdrawal, Recovery K/F refresh, same-asset close drift with real funding, malformed-hint rollback and exact OI framing, success-must-mutate/fixed-point rollback checks, both active-close/shutdown landing orders, and every shared rank/reference-model check |
