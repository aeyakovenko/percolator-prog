...
| `cargo test --test v16_program_stateful_fuzz` | 232/232 | full exact engine-`6f3c5c12`/SBF-`d70956aa` rerun completed in 290.91 seconds. The 64-world aggregate/two-way/three-way/four-way receipt route matrix, 24-world unequal three-receipt and 120-world unequal four-receipt claimant/release products, the second 24-world prior-insurance composition through gated drain and slab closure, 16-world partial-receipt release/claim matrix, four-world independent-Recovery/receipt product, and four-route terminal-expiry branch pass alongside every prior authority, policy, liquidation, payout, and bounded-reference campaign. |
