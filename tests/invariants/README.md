...
191 engine host/runtime tests, 111 public regressions, 221 public stateful/model tests, and all 916
...
exact scaled-liquidation worlds, and sixteen dual-ADL Recovery-forfeit worlds. The
...
its predicted partial close. The Recovery-forfeit product crosses both owner orders and one/max B
...
larger three-plus-account, multi-asset topology with equal-risk liquidation permutations and
independent loss-attribution normalization; transfer and retirement composition remain in the
broader INV-051 frontier.
