...
| `cargo test --test v16_program_stateful_fuzz` | 184/184 | full engine-`ba7a84b7`/SBF-`6650b2dd` rerun in 175.13 seconds, including the new 16-world pending-target/funding/withdrawal composition, 32-world clock-first mark-discovery schedule matrix, 24-world source-lien partition/expiry/exit matrix, generated aggregate/split/reversed terminal-insurance withdrawal, resolved-claim and liquidation partition matrices, Recovery K/F refresh, close drift, exact rollback, and every shared rank/reference-model check |
| Registry/manifest checks in the INV-079 module | 9/9 | rerun on the 2026-08-21 PR135 exact-pin test head |
| `cargo test --test v16_program_fuzz_regressions` | 93/93 | full engine-`ba7a84b7`/SBF-`6650b2dd` rerun in 26.70 seconds; the sealed benchmark census and invariant registries remain green |
