...
| `cargo check --tests` | pass | exact engine-`b10b3454` build completed in 18.71 seconds on the 2026-08-21 PR135 production head |
| `cargo test --lib` | 7/7 | exact engine-`b10b3454` rerun on the 2026-08-21 PR135 production head |
| `cargo test --test v16_program_stateful_fuzz` | 195/195 | exact engine-`b10b3454`/SBF-`342f7bb5` rerun in 182.02 seconds, including four independent flat-source-lien route worlds with complete terminal observations, source-complete validation of every current public trace consumer, and every prior rank/reference-model, lifecycle, source-lien, terminal, and route-composition check |
...
| `cargo test --test v16_program_fuzz_regressions` | 95/95 | full engine-`b10b3454`/SBF-`342f7bb5` exact-source rerun in 27.74 seconds; every current public trace consumer validates normalized reachability evidence, and the sealed benchmark census, audit ledger, special-method registry, and invariant registries remain green |
