...
economic progress.
The exact public four-route partition is `751 = 1 provider withdrawal + 123 insurance withdrawal +
627 retired surplus`; the strictly pre-expiry control remains `751 = 751 provider withdrawal + 0
insurance withdrawal + 0 retired surplus`. At the maximum 5,782-asset/near-10-MiB shape, the scan
...
196 engine host/runtime tests, 7 wrapper unit tests, 111 public regressions, 227 public
...
| `cargo test --test v16_program_stateful_fuzz` | 227/227 | full exact engine-`6f3c5c12`/SBF-`d70956aa` rerun completed in 240.50 seconds. The new four-route terminal-expiry branch and its pre-expiry control pass the independent stock, encumbrance, OI, custody, rollback, and terminal-liveness oracles alongside every prior authority, policy, liquidation, payout, and bounded-reference campaign. |
