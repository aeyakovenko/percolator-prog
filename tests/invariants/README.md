...
`a9735d043324f9e93f0d72994f1b89fa7ebfb2ef05cba6fdf43d357023e33a2c`. Resolved-mode
...
paths delegate to it. A source-derived roster classifies all 30 production functions containing
...
host/SBF boundary gap is closed for the current canonical adapter surface. Full-width relational
provider scaling and bigint/formal representation equivalence remain `FRONTIER`; no production
defect was found.
...
| Focused INV-085 deployed arithmetic differential | 13/13 host/CU plus 12/12 Kani and 126/126 public composite worlds | a source-derived roster owns all 30 multiply/divide-bearing production functions and keeps eight canonical fee/notional adapters in `policy_v16`; twelve wrapper policy/oracle relations match independent widened formulas over complete bounded products, fixed boundaries, and 16,384 deterministic full-width words; 512 dynamic-fee and 1,024 fee-rate-search words match exhaustive scans. Every canonical adapter is tied to an exact deployed SBF result across activation-tier, side-local fee-share, sub-atom batch, and live-OI Hybrid quote boundaries, while every legal three-provider composition topology lands its independently calculated rational E6 price. Full relational provider scaling and bigint equivalence remain frontier work. |
...
`a9735d043324f9e93f0d72994f1b89fa7ebfb2ef05cba6fdf43d357023e33a2c`.
...
| AUDIT-085 | FRONTIER | All 30 production functions with wide multiply/divide markers have one machine-enforced owner; eight wrapper fee/notional adapters are canonical pure `policy_v16` functions and the processor copies are removed. Twelve deployed price/funding/fee relations match independent widened or exhaustive references under assumption-free bounded Kani, fixed edges, and 16,384 deterministic full-width host words. The 512-word dynamic-fee and 1,024-word fee-rate-search differentials match exhaustive scans. Exact public SBF comparisons cover the first activation-fee tier, side-local fee floors, maintenance/liquidation rewards, sub-atom batch rounding, and a live-OI Hybrid fee/mark quote; a source roster keeps every canonical adapter attached to one of those witnesses. The 126-world public composite-provider matrix checks exact independent rational output across every legal multiply/divide/invert/unit-scale topology. The attempted 8-bit seven-axis EWMA relation crossed a five-minute isolated budget; the complete 3-bit product passes. Remaining work is relational full-width Pyth/Switchboard/Chainlink scaling and bigint/formal representation equivalence. Engine arithmetic is engine-owned and must not be duplicated. |
