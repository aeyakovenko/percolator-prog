...
191 engine host/runtime tests, 111 public regressions, 222 public stateful/model tests, and all 916
...
exact scaled-liquidation worlds, sixteen dual-ADL Recovery-forfeit worlds, and sixteen multi-asset
equal-risk liquidation worlds. The
...
withdrawal plus the exact configured maintenance-fee partition. The next tractable ADL work is a
three-plus-asset topology with unequal cross-domain losses, liquidation-order permutations, and an
independent residual/loss-attribution normalization oracle. Transfer, partial-receipt close, and
retirement composition remain in the broader INV-051 frontier.
