...
| `PERCOLATOR_FUZZ_CASES=2 cargo test --test v16_program_stateful_fuzz` | 211/211 | full exact engine-`d604ca0`/SBF-`25f434e2` rerun completed in 221.06 seconds; every generated public action and successful crank composes the shared invariant oracles for both markets. The suite includes the 56-world one-domain, 48-world two-domain, and 48-world mixed-expiry INV-052 source-lien matrices, exact per-portfolio source attribution and close exclusion, the asymmetric-fee INV-041 order regression, INV-076 rollback frames, the finding-blind 21-family retained asset-generation matrix, source-domain single-use, retained source-fee consent, and backing-provider landing-order campaigns. All authority, policy, lifecycle, liveness, accounting, and model campaigns pass. |
...
| `cargo test --test v16_program_fuzz_regressions` | 106/106 | full exact engine-`d604ca0`/SBF-`25f434e2` rerun completed in 27.39 seconds; includes all public regressions, trace consumers, executable registries, and the source-complete INV-079 evidence roster |
| `cargo test --test v16_cu` | 899/899 | full exact engine-`d604ca0`/SBF-`25f434e2` rerun completed in 204.17 seconds; zero behavioral failures across reserve, fee-consent, oracle, Recovery, terminal, lifecycle, source-lien normalization, selector composition, and maximum-shape routes. Every observed required exit remains below the 1.4M CU ceiling. |
| `cargo kani --bin v16-kani --features kani --default-unwind 18 --output-format terse` | 187/187 | full wrapper-only exact-source rerun with engine `d604ca0`; zero failures after all decoder, identity-binding, assumption-nonvacuity, provider-parser, and deployed-arithmetic harnesses, with required constructive covers satisfied |
...
SHA-256 `25f434e21e451e83e79f8346bbb544518dce62907552c3b14f91d299670e3771`.
...
On engine pin `d604ca09b7e584d3875ce4516bab1186346bf4a6`, the full 899-test `v16_cu` inventory is
