...
| `stateful/` | 101 | Proptest-generated public routes, including thirty-three finding-agnostic discovery properties |
...
**Direct regression** rows, 54 **Missing** rows, and 89 **Independent discovery** rows. The independent
