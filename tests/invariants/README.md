...
| `cu/` | 97 | Positive public-route, metamorphic, rollback, liveness, and max-shape CU tests |
...
**Direct regression** rows, 7 **Missing** rows, 122 **Independent discovery** rows, and fourteen
