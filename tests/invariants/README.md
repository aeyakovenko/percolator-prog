...
5. Cross INV-086's now-public underfunded terminal graph with recovery, insurance impairment,
...
6. The base graph now extends every exact authenticated tracked depth-three wrapper state by every
...
The current ledger is 64 **CLOSED**, 1 **OPEN-T**, 10 **OPEN-D**, 0 **PARTIAL**, 12 **FRONTIER**,
