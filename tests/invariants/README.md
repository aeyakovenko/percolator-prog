...
| `cu/` | 98 | Positive public-route, metamorphic, rollback, liveness, and max-shape CU tests |
...
**Direct regression** rows, 6 **Missing** rows, 123 **Independent discovery** rows, and fourteen
