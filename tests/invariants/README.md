...
| Focused INV-052 canonical crank/ADL/insurance/claim partition matrix | 11/11 CU plus 11/11 stateful, 5/5 engine Kani, and 1/1 wrapper Kani | generated live, resolved, shutdown/Recovery, owner-reduction, live asset-insurance, terminal market-wide insurance, atomic backed-claim conversion, resolved-claim, and proportional-liquidation partitions plus exact post-ADL zero-sum settlement rerun on the 2026-08-21 PR135 production head |
...
| `cargo test --test v16_program_stateful_fuzz` | 181/181 | full engine-`3b76b794`/SBF-`97eb59e9` rerun in 164.79 seconds, including generated aggregate/split/reversed terminal-insurance withdrawal, the 16-route resolved-claim split matrix, the 12-world proportional-liquidation split/order matrix, Recovery K/F refresh, same-asset close drift with real funding, malformed-hint rollback and exact OI framing, success-must-mutate/fixed-point rollback checks, both active-close/shutdown landing orders, and every shared rank/reference-model check |
...
3. Apply INV-052's split/merge oracle to multi-asset or larger-account liquidation,
   multi-domain/expiry lien consumption, cooldowns, rates, and policy limits. Proportional
