...
| `cu/` | 75 | Positive public-route, metamorphic, rollback, liveness, and max-shape CU tests |
...
**Direct regression** rows, 37 **Missing** rows, 105 **Independent discovery** rows, and one
