...
873/873 LiteSVM/CU tests, 100/100 public fuzz regressions, and 206/206 stateful/model tests. Static
...
prevents this progress from being overstated: 35 instruction variants have exhaustive current-shape
matrices, four have an explicitly named dynamic-tail/action gap, and eleven remain open. Fresh
market initialization now exhausts all three account-role aliases and both required privilege
downgrades from a System Program-created account, with a successful readable-market control. The exact
...
| `cargo test --test v16_cu` | 873/873 | full engine-`b10b3454`/SBF-`fb16e50e` exact-source rerun passed in 193.59 seconds on the 2026-08-26 checkpoint; zero failures, including the fresh-`InitMarket` role matrix and every prior maximum-shape and invariant route |
...
| `cu/` | 873 | Public-route, metamorphic, rollback, liveness, arithmetic-differential, and maximum-shape LiteSVM coverage. It includes source-complete ownership and account-role disposition rosters for all 50 instructions, real SPL/CPI boundaries, retained-intent failures and retries, 60 partial-fill route/ratio/maximum-domain worlds, lifecycle and terminal exits, hostile hint/oracle/matcher inputs, full supported shapes, and exact custody/accounting checks. |
...
On engine pin `b10b3454dd03dcf4c04a020dc1a90381ff179200`, the full 873-test `v16_cu` inventory is
