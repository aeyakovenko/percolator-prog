...
zero partial/open rows; every cited role test is present, and the exact 905-test CU run executes the
...
The current ledger is 31 **CLOSED**, 33 **OPEN-T**, 11 **OPEN-D**, 0 **PARTIAL**, 12 **FRONTIER**,
