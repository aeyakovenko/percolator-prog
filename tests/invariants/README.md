...
| `cu/` | 73 | Positive public-route, metamorphic, rollback, liveness, and max-shape CU tests |
...
**Direct regression** rows, 39 **Missing** rows, and 104 **Independent discovery** rows. The independent
