...
The unrelated guard reconciliation was subsequently applied on the coordinator
branch in `da83e0e6`, then preserved by the current branch. It does not prevent
