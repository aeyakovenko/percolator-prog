...
use support::{
    ...
    fuzz_model::{
        ...
        reproduce_fractional_cap_settlement, reproduce_insurance_withdrawal_generation_replay,
...
fn v16_program_open_lof_manifest_is_complete_and_honest() {
    ...
    assert_eq!(
        ...
        [
            ...
            279, 280, 281, 282, 283, 290, 320, 328, 329, 331, 332, 333, 343, 356, 365, 366, 367,
            369, 380, 381
        ]
    );
