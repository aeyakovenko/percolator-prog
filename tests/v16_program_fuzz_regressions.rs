...
use support::{
    ...
    invariant_discovery::{
        ...
        discover_fee_redirect_supersession, discover_intent_retries, discover_intent_retry,
        discover_liquidation_share_supersession, discover_maintenance_share_supersession,
        discover_matcher_revocation_terminal_loss,
        ...
        discover_resolve_policy_bounded_liveness, discover_retained_maturity_terminal_locks,
        ...
        discover_trade_intent_retry_terminals, verify_composite_time_coherence,
